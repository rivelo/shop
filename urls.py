...
#    url(r'^invoice/manufacture/view/$', catalog.invoicecomponent_list_by_manufacturer'),
    url(r'^invoice/manufacture/view/$', catalog.invoicecomponent_list, {'focus': 1}),
...
#    url(r'^client/invoice/add/$', catalog.client_invoice'),
    ...
    url(r'^client/invoice/(?P<id>\d+)/delete/$', catalog.client_invoice_delete, name="client_invoice_delete"),    
    url(r'^client/invoice/year/(?P<year>\d+)/month/(?P<month>\d+)/view/$', catalog.client_invoice_view, {'day':"all"}),
    url(r'^client/invoice/year/(?P<year>\d+)/month/(?P<month>\d+)/day/(?P<day>\d+)/view/$', catalog.client_invoice_view, name="client_invoice_day"),
    url(r'^client/invoice/year/(?P<year>\d+)/month/(?P<month>\d+)/view/notpay/$', catalog.client_invoice_view, {'day':"all", 'notpay': True}),
    url(r'^client/invoice/year/(?P<year>\d+)/month/(?P<month>\d+)/day/(?P<day>\d+)/view/notpay/$', catalog.client_invoice_view, {'notpay': True}),
...
#urlpatterns += patterns('',
    ...
    url(r'^phonestatus/add/$', catalog.phonestatus_add),
    url(r'^phonestatus/edit/(?P<id>\d+)$', catalog.phonestatus_edit),
    url(r'^phonestatus/delete/(?P<id>\d+)$', catalog.phonestatus_delete),
