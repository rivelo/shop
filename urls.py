...
#    (r'^invoice/category/(?P<cid>\d+)/view/$', 'catalog.accounting.views.invoicecomponent_list_by_category'),
    ...
    (r'^catalog/sale/edit/$', 'catalog.accounting.views.catalog_sale_edit'),
...
#delete    (r'^client/result/$', 'catalog.accounting.views.search_client_id'),
    ...
    (r'^client/invoice/add/$', 'catalog.accounting.views.client_invoice_add'),
...
#    (r'^client/invoice/add/$', 'catalog.accounting.views.client_invoice'),
    (r'^client/invoice/delete/$', 'catalog.accounting.views.client_invoice_delete'),
    ...
    (r'^client/invoice/report/$', 'catalog.accounting.views.client_invoice_report'),
...
#    (r'^shop/price/print/add/$', 'catalog.accounting.views.ajax_price_print'),
    ...
    (r'^inventory/get/listid/$', 'catalog.accounting.views.inventory_get_listid'),
...
#    (r'^inventory/delete/(?P<id>\d+)/$', 'catalog.accounting.views.inventory_delete'),
    ...
    (r'^check/list/now/$', 'catalog.accounting.views.check_list',{'all':False}),
    ...
    (r'^check/workshop/add/$', 'catalog.accounting.views.workshop_sale_check_add'),
