...
# ?    url(r'^bicycle/all/view/$', 'catalog.accounting.views.bicycle_all_list'),
    ...
    url(r'^dealer/invoice/edit/(?P<id>\d+)/$', 'catalog.accounting.views.dealer_invoice_edit'),
    url(r'^dealer/invoice/delete/(?P<id>\d+)/$', 'catalog.accounting.views.dealer_invoice_del'),
    url(r'^dealer/invoice/import/$', 'catalog.accounting.views.invoice_import'),
...
#    url(r'^invoice/manufacture/(?P<mid>\d+)/availability/view/$', 'catalog.accounting.views.invoicecomponent_list_by_manufacturer', {'availability': 1}),
    url(r'^invoice/manufacture/(?P<mid>\d+)/availability/view/html/$', 'catalog.accounting.views.invoicecomponent_manufacturer_html'),    
    url(r'^invoice/category/(?P<mid>\d+)/availability/view/html/$', 'catalog.accounting.views.invoicecomponent_category_html'),
...
#    url(r'^invoice/category/(?P<cid>\d+)/view/$', 'catalog.accounting.views.invoicecomponent_list_by_category'),
    ...
    url(r'^invoice/catalog/(?P<cid>\d+)/view/$', 'catalog.accounting.views.invoice_cat_id_list'), # наявний товар
    ...
    url(r'^catalog/id/(?P<id>\d+)/view/$', 'catalog.accounting.views.catalog_list'),
...
#    url(r'^shop/price/print/add/$', 'catalog.accounting.views.ajax_price_print'),
    ...
    url(r'^shop/price/print/view/$', 'catalog.accounting.views.shop_price_print_view'),
    ...
    url(r'^catalog/price/import/$', 'catalog.accounting.views.price_import'),
