...
#    url(r'^bicycle/sale/id/(?P<id>\d+)/view/$', 'catalog.accounting.views.bicycle_sale_list'),
    url(r'^bicycle/sale/id/(?P<id>\d+)/view/$', 'catalog.accounting.views.bicycle_sale_list_by_brand'),
    url(r'^bicycle/sale/view/$', 'catalog.accounting.views.bicycle_sale_list_by_brand'),
    url(r'^bicycle/sale/year/(?P<year>\d+)/view/$', 'catalog.accounting.views.bicycle_sale_list_by_brand', name='bicycle-sale-by-year'),
    url(r'^bicycle/sale/year/(?P<year>\d+)/month/(?P<month>\d+)/view/$', 'catalog.accounting.views.bicycle_sale_list_by_brand', name='bicycle-sale-by-year-month'),
    url(r'^bicycle/sale/brand/(?P<id>\d+)/year/(?P<year>\d+)/month/(?P<month>\d+)/view/$', 'catalog.accounting.views.bicycle_sale_list_by_brand', name='bicycle_year_month_sale_by_brand'),    
    url(r'^bicycle/sale/brand/(?P<id>\d+)/year/(?P<year>\d+)/view/$', 'catalog.accounting.views.bicycle_sale_list_by_brand', name="bicycle_year_sale_by_brand"),
    url(r'^bicycle/sale/brand/(?P<id>\d+)/all/$', 'catalog.accounting.views.bicycle_sale_list_by_brand', {'all': True, },  name="bicycle_sale_all_by_brand" ),
    ...
    url(r'^dealer/invoice/(?P<id>\d+)/recived/set/$', 'catalog.accounting.views.dealer_invoice_set', name='dealear_invoice_set_status'),
...
#    url(r'^invoice/manufacture/(?P<mid>\d+)/view/$', 'catalog.accounting.views.invoicecomponent_list_by_manufacturer'),
    url(r'^invoice/manufacture/(?P<mid>\d+)/view/$', 'catalog.accounting.views.invoicecomponent_list', {'all': False}),    
    url(r'^invoice/manufacture/(?P<mid>\d+)/view/all/$', 'catalog.accounting.views.invoicecomponent_list', {'all': True}, name="manufacture_id_list_all"),
    url(r'^invoice/year/(?P<sel_year>\d+)/manufacture/(?P<mid>\d+)/view/$', 'catalog.accounting.views.invoicecomponent_list', {'all': True}, name="invoice_year_manufacture"),
    url(r'^invoice/year/(?P<sel_year>\d+)/category/(?P<cid>\d+)/view/$', 'catalog.accounting.views.invoicecomponent_list', {'all': True}, name="invoice_year_category"),
...
#    url(r'^invoice/category/(?P<cid>\d+)/view/$', 'catalog.accounting.views.invoicecomponent_list_by_category'),
    url(r'^invoice/category/(?P<cid>\d+)/view/$', 'catalog.accounting.views.invoicecomponent_list', {'all': False}, name="category_id_list"),
    url(r'^invoice/category/(?P<cid>\d+)/view/all/$', 'catalog.accounting.views.invoicecomponent_list', {'all': True}, name="category_id_list_all"),
    ...
    url(r'^invoice/id/(?P<id>\d+)/view/$', 'catalog.accounting.views.invoice_id_list', name='invoice-view'),
    url(r'^invoice/id/(?P<id>\d+)/view/delete/$', 'catalog.accounting.views.invoice_id_list_delete', name='invoice-list-delete'),    
    ...
    url(r'^catalog/add/$', 'catalog.accounting.views.catalog_add', name="catalog_add"),
...
#delete    url(r'^client/result/$', 'catalog.accounting.views.search_client_id'),
    ...
    url(r'^client/invoice/view/notpay/$', 'catalog.accounting.views.client_invoice_view', {'notpay': True}),
    url(r'^client/invoice/set/$', 'catalog.accounting.views.client_invoice_set'),
    url(r'^client/invoice/(?P<id>\d+)/edit/$', 'catalog.accounting.views.client_invoice_edit', name="client_invoice_edit"),
...
# ajax table for client invoice    
    ...
    url(r'^client/invoice/catalog/(?P<id>\d+)/view/$', 'catalog.accounting.views.client_invoice_id', name="client_catalog_sale"),
    url(r'^client/invoice/catalog/(?P<id>\d+)/view/notpay/$', 'catalog.accounting.views.client_invoice_id', {'notpay': True}),
#    url(r'^client/invoice/add/$', 'catalog.accounting.views.client_invoice'),
    ...
    url(r'^client/invoice/(?P<id>\d+)/delete/$', 'catalog.accounting.views.client_invoice_delete', name="client_invoice_delete"),    
    url(r'^client/invoice/year/(?P<year>\d+)/month/(?P<month>\d+)/view/$', 'catalog.accounting.views.client_invoice_view', {'day':"all"}),
    url(r'^client/invoice/year/(?P<year>\d+)/month/(?P<month>\d+)/day/(?P<day>\d+)/view/$', 'catalog.accounting.views.client_invoice_view', name="client_invoice_day"),
    url(r'^client/invoice/year/(?P<year>\d+)/month/(?P<month>\d+)/view/notpay/$', 'catalog.accounting.views.client_invoice_view', {'day':"all", 'notpay': True}),
    url(r'^client/invoice/year/(?P<year>\d+)/month/(?P<month>\d+)/day/(?P<day>\d+)/view/notpay/$', 'catalog.accounting.views.client_invoice_view', {'notpay': True}),
    ...
    url(r'^payform/dealer/$', 'catalog.accounting.views.dealer_payform'),
...
urlpatterns += patterns('',
    ...
    url(r'^workticket/edit/(?P<id>\d+)/$', 'catalog.accounting.views.workticket_edit', name="workticket_edit"),    
    ...
    url(r'^workshop/view/$', 'catalog.accounting.views.workshop_list', name='workshop_list'),
    url(r'^workshop/year/(?P<year>\d+)/month/(?P<month>\d+)/day/(?P<day>\d+)/view/$', 'catalog.accounting.views.workshop_list', name='workshop_day'),
...
#    url(r'^insertstory/$', 'catalog.accounting.views.insertstory'),
    ...
    url(r'^report/sales/user/(?P<user_id>\d+)/report/$', 'catalog.accounting.views.user_invoice_report', {'day':"all"}, name='report_sales_by_user_currentmonth'),
    ...
    url(r'^report/sales/user/(?P<user_id>\d+)/year/(?P<year>\d+)/month/(?P<month>\d+)/report/$', 'catalog.accounting.views.user_invoice_report', {'day':"all"}, name='report_sales_by_user_month'),
    url(r'^report/sales/user/(?P<user_id>\d+)/year/(?P<year>\d+)/month/(?P<month>\d+)/day/(?P<day>\d+)/report/$', 'catalog.accounting.views.user_invoice_report', name='report_sales_by_user_day'),

    url(r'^report/workshop/byuser/$', 'catalog.accounting.views.user_workshop_report', {'day':"all"}),
    url(r'^report/workshop/(?P<user_id>\d+)/byuser/$', 'catalog.accounting.views.user_workshop_report', {'day':"all"}, name='report_workshop_by_user_currentmonth'),
    ...
    url(r'^report/workshop/(?P<user_id>\d+)/byuser/year/(?P<year>\d+)/month/(?P<month>\d+)/$', 'catalog.accounting.views.user_workshop_report', {'day':"all"}, name='report_workshop_by_user_month'),
    ...
    url(r'^shop/price/lastadded/(?P<id>\d+)/view/$', 'catalog.accounting.views.shop_price_lastadd', name="shop-price-last-added"),    
    ...
    url(r'^shop/price/bysearch_id/(?P<id>.*)/print/$', 'catalog.accounting.views.shop_price_bysearch_id_print', name="shop-price-by-search-id-print"),
...
#    url(r'^shop/price/print/add/$', 'catalog.accounting.views.ajax_price_print'),
    ...
    url(r'^shop/price/print/add/invoice/$', 'catalog.accounting.views.shop_price_print_add_invoice'),
    url(r'^shop/price/print/view/$', 'catalog.accounting.views.shop_price_print_list', {'pprint': True}, name='label_print_all'),
    url(r'^shop/price/print/view/(?P<user_id>\d+)/byuser/$', 'catalog.accounting.views.shop_price_print_list', {'pprint': True}, name='label_print_by_user'),
    ...
    url(r'^shop/price/print/duplicate/delete/$', 'catalog.accounting.views.remove_duplicated_ShopPrice_records', name='shopprice_duplicate_delete'),
    url(r'^shop/price/print/zero/delete/$', 'catalog.accounting.views.remove_zero_ShopPrice_records', name='shopprice_zero_delete'),
    url(r'^shop/price/print/list/$', 'catalog.accounting.views.shop_price_print_list', name='shop-price-print-list'),
    url(r'^shop/price/print/list/add/$', 'catalog.accounting.views.shop_price_print_list_add', name='shop-price-print-list-add'),
    url(r'^shop/price/print/list/(?P<user_id>\d+)/byuser/$', 'catalog.accounting.views.shop_price_print_list', name='label_list_by_user'),
    url(r'^shop/price/print/delete/$', 'catalog.accounting.views.shop_price_print_delete'),
    url(r'^shop/price/print/delete/(?P<user_id>\d+)/byuser/$', 'catalog.accounting.views.shop_price_print_delete', name='label_delete_by_user'),
    ...
    #url(r'^catalog/content/import/form/$', 'catalog.accounting.views.catalog_import_form'),
    url(r'^catalog/import/$','catalog.accounting.views.catalog_import_form'),
    url(r'^catalog/content/import/$', 'catalog.accounting.views.catalog_import_content'),
    ...
    url(r'^shop/sale/day/add/$', 'catalog.accounting.views.shopdailysales_add', name='shop-sale-day-add'),
    ...
    url(r'^shop/year/(?P<year>\d+)/month/(?P<month>\d+)/day/(?P<day>\d+)/view/$', 'catalog.accounting.views.shopdailysales_view', name="shop-daily-sales"), # Day CASA     
    url(r'^shop/year/(?P<year>\d+)/month/(?P<month>\d+)/day/(?P<day>\d+)/shop/(?P<shop>\d+)/view/$', 'catalog.accounting.views.shopdailysales_view', name="shop-daily-sales-by-shop"), # day CASA by SHOP
...
#    url(r'^inventory/delete/(?P<id>\d+)/$', 'catalog.accounting.views.inventory_delete'),
    ...
    url(r'^check/pay/(?P<id>\d+)/delete/$', 'catalog.accounting.views.check_pay_delete', name='check_pay_delete'),
    ...
    url(r'^discount/year/(?P<year>\d+)/list/$', 'catalog.accounting.views.discount_list', name="discount_year_list"),
