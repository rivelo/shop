...
#    url(r'^shop/price/print/add/$', 'catalog.accounting.views.ajax_price_print'),
    ...
    url(r'^inventory/autofix/$', 'catalog.accounting.views.inventory_fix_catalog1', name="fix_inventory"),
    url(r'^inventory/type/(?P<type_id>\d+)/autofix/$', 'catalog.accounting.views.inventory_fix_catalog1', name="fix_inventory"),
