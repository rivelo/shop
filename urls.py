...
#    url(r'^client/(?P<id>\d+)$', catalog.client_data, name="client-data"),
    ...
    url(r'^client/edit/(?P<id>\d+)$', catalog.client_edit, {'page_label': 'Редагування клієнта'}, name="client-edit"),
...
#    url(r'^client/invoice/add/$', catalog.client_invoice'),
    ...
    url(r'^clientdebts/delete/(?P<id>\d+)$', catalog.clientdebts_delete, name='client-debet-delete'),
    ...
    url(r'^clientcredits/delete/(?P<id>\d+)/$', catalog.clientcredits_delete, name='client-credit-delete'),
